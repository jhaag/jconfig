...
Since I am now writing much of my emacs configuration in ~org-mode~ files, and because I intend to break it up somewhat, I define a useful helper which can load my file.
  ...
  (let ((filename (expand-file-name filename)))
    (if (file-readable-p filename)
        (progn
          ...
          (load (concat (file-name-directory filename) "tangles/" (file-name-base filename) extension)))
      (warn "Missing configuration file: %s"))))
#+END_SRC
...
- Next, I ensure that trailing whitespace is always deleted when I save a file.
