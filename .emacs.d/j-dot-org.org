#+PROPERTY: header-args:emacs-lisp :tangle (concat (expand-file-name "~/jconfig/.emacs.d/tangles/") (file-name-base) ".el") :noweb-ref org-utils
  ...
  (use-package org-super-agenda
    ...
    (org-super-agenda-groups
     '(;; Each group has an implicit boolean OR operator between its selectors.
       ...
       (:todo "NEXT" :order 2)
       (:name "DEADLINES" :auto-parent t :deadline t :order 3)
       (:priority<= "B"
