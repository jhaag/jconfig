...
#+BEGIN_SRC emacs-lisp :tangle-no :noweb-ref org-mode-config
(setq j/org/refile-path "~/Dropbox/org/")
(setq org-capture-templates
      `(("s" "schedule")
        ("ss" "schedule single" entry (file (concat j/org/refile-path "refile.org"))
         "* TODO %?\nSCHEDULED: %^{When}T\n")
        ("sr" "schedule repeat" entry (file (concat j/org/refile-path "refile.org"))
         "* TODO \nSCHEDULED: %^{When}T%?\n")
        ("t" "todo")
        ("ts" "short todo" entry (file+headline (concat j/org/refile-path "refile.org") "Shorts")
         ,j/org/capture/template/next :clock-in t :clock-resume t)
        ("tn" "dateless todo" entry (file (concat j/org/refile-path "refile.org"))
         ,(concat "* TODO %?\n" (j/org/capture/template/properties)) :clock-in t :clock-resume t)
        ("td" "dated todo" entry (file (concat j/org/refile-path "refile.org"))
         ,(concat "* TODO %?\nDEADLINE: %^{Due Date}t\n" (j/org/capture/template/properties)) :clock-in t :clock-resume t)
        ("r" "respond" entry (file (concat j/org/refile-path "refile.org"))
         ,(concat "* NEXT RESPOND to %:from on %:subject\nSCHEDULED: %t\n" (j/org/capture/template/properties)) :clock-in t :clock-resume t :immediate-finish t)
        ("n" "note" entry (file (concat j/org/refile-path "refile.org"))
         ,(concat "* %? :NOTE:\n" (j/org/capture/template/properties)) :clock-in t :clock-resume t)
        ("j" "Journal" entry (file+olp+datetree (concat j/org/refile-path "diary.org"))
         "* %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n\n" :clock-in t :clock-resume t)
        ("m" "Meeting" entry (file (concat j/org/refile-path "refile.org"))
         ,(concat "MEETING with %? :MEETING:\n" (j/org/capture/template/properties)) :clock-in t :clock-resume t)
        ("p" "Phone Call" entry (file (concat j/org/refile-path "refile.org"))
         ,(concat "PHONE %? :PHONE:\n" (j/org/capture/template/properties)) :clock-in t :clock-resume t)
        ("h" "Habit" entry (file+headline (concat j/org/refile-path "todo.org") "Habits")
